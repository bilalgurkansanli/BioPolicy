...
> [`eval/run_eval.py`](./eval/run_eval.py) against live models and a live
> database — sections still marked _pending_ have no measurements yet, and are
> deliberately left empty rather than filled with plausible-looking placeholders.
