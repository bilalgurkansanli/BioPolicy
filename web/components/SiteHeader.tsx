      ...
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center gap-3 px-4 sm:gap-5 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative">
            {/* The halo is its own element rather than a pseudo-element so it can
                paint over the translucent header background instead of under it.
                It is dropped on /app, where the button is already the page. */}
            {!onWorkspace && (
              <span
                aria-hidden
